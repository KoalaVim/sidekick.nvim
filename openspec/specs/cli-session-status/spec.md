...
Defines requirements for exposing AI CLI session activity status (idle, working, blocked, unknown) through sidekick's status API, enabling statusline components and other consumers to reflect real-time agent state.
